                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <select name="type" id="type" 
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                                    <option value="" @if(old('type') == '') selected @endif>Select Type</option>
                                    <option value="school" @if(old('type') == 'school') selected @endif>School</option>
                                    <option value="college" @if(old('type') == 'college') selected @endif>College/University</option>
                                    <option value="club" @if(old('type') == 'club') selected @endif>Sports Club</option>
                                    <option value="federation" @if(old('type') == 'federation') selected @endif>Sports Federation</option>
                                    <option value="academy" @if(old('type') == 'academy') selected @endif>Sports Academy</option>
